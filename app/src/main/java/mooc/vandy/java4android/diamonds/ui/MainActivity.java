...
public class MainActivity 
    ...
    public void buttonPressed(View buttonPress) {
        ...
        if(String.valueOf(mSizeSpinner.getSelectedItem().toString()).equals("Stop")){
            TextView tv= findViewById(R.id.outputET);
            tv.setHint("Output Will Appear Here...");
        }
        else {
            mLogic.process(Integer.valueOf(mSizeSpinner.getSelectedItem().toString()));
        }
    }
    public void buttonDone(View buttonPress){
        Button done=(Button)findViewById(R.id.btnDone);
